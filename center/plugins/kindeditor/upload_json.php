...
//文件根目录
$file_service = 'http://file.directsale.com/';
//文件保存目录路径
...
if (empty($_FILES) === false) {
	...
	$file_real_path = str_replace('\\', '/', realpath($file_path));
	$document_root_path = realpath($_SERVER['DOCUMENT_ROOT']);
    $file_url = $file_service.substr($file_real_path, strlen(str_replace('\\', '/', $document_root_path)));
