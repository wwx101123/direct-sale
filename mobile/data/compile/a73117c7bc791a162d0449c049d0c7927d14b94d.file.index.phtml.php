<?php /* Smarty version Smarty-3.1.13, created on 2015-11-26 18:38:50
...
function bootstrap() {
    $.post("../api/delay.php", { "opera":"collection", "product_sn":"1" }, get_data_handler, "json");
}

function get_data_handler(response) {
    alert(response);
    hide_mask();
}
</script>
